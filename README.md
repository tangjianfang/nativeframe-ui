...
| `NativeFrameUICharts.exe` | 2x2 chart gallery (vertical bar / horizontal bar / line / spline) backed by the `nfui_charts` module; the spline renderer uses Catmull-Rom interpolation converted to cubic Beziers via `catmull_rom_to_bezier` | [Charts Guide](docs/CHARTS.md) |
