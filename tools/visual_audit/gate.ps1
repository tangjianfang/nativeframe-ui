...
Write-Host "  NOTE: real per-pixel diff scoring now lives in tools/visual_audit/diff_scorer.ps1,"
Write-Host "  registered as the NativeFrameUIPerPixelDiff CTest. Run that for the actual gate."
exit 0
